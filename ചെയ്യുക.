...
# 1. THE SUPREME TITAN PURGE (Fixes Connection Refused)
...
# 2. X11 ENGINE: QUANTUM OVERCLOCK (Image Link Fix)
...
# 5. THE ATOMIC BYPASS (The Fix for Menu Loops)
echo -e "\e[1;32m🧠 SYNC COMPLETE: FORCING DIRECT DESKTOP ENTRY...\e[0m"
# '-u root' and '-c' bypass the udroid menu shown in your screenshot
