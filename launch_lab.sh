...
# 🛠️ Engine: Aadarsh | ⚙️ Gear: iQOO Z6 Snapdragon Elite Adrenaline
# 🛡️ Protocol: AGGRESSIVE TITAN PURGE & INFINITE CLOUD SYNC
# =====================================================================
...
# 1. THE OLYMPUS TITAN PURGE (Zero-Ghost Session Fix)
echo -e "\e[1;31m⚡ TITAN PURGE: Vaporizing system ghosts for Maximum RAM...\e[0m"
# Kill all possible conflicting processes aggressively
pkill -9 -f termux-x11; pkill -9 -f xfce4; pkill -9 -f dbus; pkill -9 -f pulseaudio; pkill -9 -f node; pkill -9 -f udroid
# Force clear all lock files and sockets (Fixes "Connection Refused")
rm -rf $TMPDIR/.X* $TMPDIR/dbus-* $TMPDIR/pulse-* ~/.config/chromium/SingletonLock /tmp/.X11-unix/X* /data/data/com.termux/files/usr/tmp/.X11-unix/X*
sleep 1
...
# 3. SNAPDRAGON ELITE TURBO (Adrenaline Hardware Tuning)
echo -e "\e[1;33m🚀 ADRENALINE: Optimizing iQOO Z6 Snapdragon Pipelines...\e[0m"
# Start High-Priority Audio Server for Pro-Development
pulseaudio --start --load="module-native-protocol-tcp auth-ip-acl=127.0.0.1 auth-anonymous=1" --exit-idle-time=-1

# 4. QUANTUM DISPLAY OVERCLOCK (Instant Image Fix)
echo -e "\e[1;34m🖥️ X11 TURBO: Starting Ultra-High FPS Visual Hub...\e[0m"
# Launching with TCP listening and MIT-SHM for lag-free coding
termux-x11 :1 -listen tcp -ac -extension MIT-SHM > /dev/null 2>&1 & 
sleep 3

# 5. FORCE-LAUNCH VISUAL INTERFACE (Auto-Switch)
# This forces your phone to open the Termux-X11 App automatically
am start --user 0 -n com.termux.x11/com.termux.x11.MainActivity > /dev/null 2>&1
sleep 1

# 6. THE SINGULARITY (Ubuntu God-Mode Command)
...
udroid login jammy -- /bin/bash -c "
    ...
    # Clean browser and VS Code locks for smooth entry
